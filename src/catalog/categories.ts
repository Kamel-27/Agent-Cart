...
export const CATEGORY_ATTRS: Record<CanonicalCategory, AttrSpecMap> = {
  smartphones: {
    storage_gb: { kind: "number", integer: true, unit: "GB", min: 8, max: 2048, desc: "Internal storage capacity", better: "higher" },
    ram_gb: { kind: "number", integer: true, unit: "GB", min: 1, max: 32, desc: "RAM, excluding virtual RAM", better: "higher" },
    screen_in: { kind: "number", unit: "inches", min: 3, max: 8, desc: "Display diagonal", better: "none" },
    display_type: { kind: "enum", values: ["AMOLED", "OLED", "IPS LCD", "TFT LCD", "LTPO AMOLED"], desc: "Display panel technology", better: "none" },
    refresh_hz: { kind: "number", integer: true, unit: "Hz", min: 60, max: 240, desc: "Maximum display refresh rate", better: "higher" },
    battery_mah: { kind: "number", integer: true, unit: "mAh", min: 1000, max: 12000, desc: "Battery capacity", better: "higher" },
    charging_w: { kind: "number", integer: true, unit: "W", min: 5, max: 300, desc: "Maximum wired charging power", better: "higher" },
    chipset: { kind: "string", maxLength: 60, desc: "SoC name, e.g. 'Dimensity 7300+' or 'Snapdragon 8 Gen 3'", better: "none" },
    rear_camera_mp: { kind: "number", unit: "MP", min: 0.3, max: 250, desc: "Main rear camera resolution", better: "higher" },
    front_camera_mp: { kind: "number", unit: "MP", min: 0.3, max: 100, desc: "Front camera resolution", better: "higher" },
    has_5g: { kind: "boolean", desc: "Supports 5G networks", better: "higher" },
    dual_sim: { kind: "boolean", desc: "Accepts two SIMs (physical or eSIM)", better: "none" },
    nfc: { kind: "boolean", desc: "Has NFC", better: "none" },
    os: { kind: "enum", values: ["Android", "iOS", "HarmonyOS"], desc: "Operating system", better: "none" },
    color: { kind: "string", maxLength: 40, desc: "Colour of this specific variant", better: "none" },
  },
